...
const Icons = ({size}: Props) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={{margin:"auto", background:"#fff", display:"block"}} width={size || "200px"} height={size || "200px"} viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
